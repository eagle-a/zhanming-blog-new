...
export default function BlogListClient({ initialItems, initialCategories }: { initialItems: BlogIndexItem[]; initialCategories: string[] }) {
	const { items, loading } = useBlogIndex(initialItems)
