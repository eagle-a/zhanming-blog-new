			...
			<form onSubmit={handleSubmit} className='space-y-4'>
				<div>
					...
					<div
						...
						className='bg-secondary/10 mx-auto flex h-32 w-32 cursor-pointer items-center justify-center rounded-full border border-gray-300 transition-colors hover:bg-gray-200'>
						{previewFile ? (
